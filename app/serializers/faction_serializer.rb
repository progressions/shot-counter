class FactionSerializer < ActiveModel::Serializer
  attributes :id, :name, :description, :image_url, :active, :vehicle_ids, :character_ids, :site_ids, :juncture_ids, :party_ids, :created_at, :updated_at, :entity_class
  ...
  has_many :vehicles, serializer: VehicleSerializer do
    object.characters.order(:name)
  end
