...
Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ "https://chiwar.net"]
  ...
  # config.active_job.queue_name_prefix = "shot_server_production"
  ...
  config.x.active_storage_url_options = {
    host: "chiwar-production.s3.amazonaws.com/",
    protocol: "https",
  }
