...
INSERT INTO weapons (
  ...
  '7b17864e-4e39-41c2-a5b7-6bbbd5aa4ff2',
  'American Derringer Mini-Cop Automatic Pistol',
  11,
  1,
  6,
  NOW(),
...
INSERT INTO weapons (
  ...
  '7b17864e-4e39-41c2-a5b7-6bbbd5aa4ff2',
  '8/1/4 Smith & Wesson 3566 Automatic Pistol',
  11,
  3,
  3,
  NOW(),
...
-- Note: Active Storage attachments need to be recreated in production

-- The following attachment records are for reference only

-- Attachment for Character 115f61d2-3839-42fc-9f85-d9765c7bf1f7
-- Original filename: Archer.png
...
-- Attachment for Character 5c62b67e-21bb-45f7-939a-c10547fa7015
-- Original filename: Bandit.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 5ef803e9-4696-4df7-b12e-4766176d82b3
-- Original filename: Big Bruiser.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character d39997e5-f720-49d5-a43b-83a2d983e037
-- Original filename: Bodyguard.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character ac248717-2f82-44b5-ac39-83b582777a96
-- Original filename: Cyborg.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 322d42d3-26a5-46d0-8eb8-977da4ce996c
-- Original filename: Drifter.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 85a65881-99b7-4aba-91d9-7e759b8c761e
-- Original filename: Driver.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 8d1afe00-b16f-4698-95f3-64fc2e997f9e
-- Original filename: Everyday Hero.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character f64b9dc7-e53c-4fdd-8eeb-6480451df853
-- Original filename: Exorcist Monk.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 23bde1d7-2561-4418-bd1b-47920351338d
-- Original filename: Full-Metal Nutball.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character f7d9c375-eee7-47ec-8975-90aefe08000a
-- Original filename: Gambler.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 317a298c-a051-46f2-9eb4-1833503fbcf6
-- Original filename: Ghost.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 5c1abd1d-aa9a-449c-87ac-c06b7795d94e
-- Original filename: Highway Ronin.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 8b42e03c-2609-4ab1-85ec-47075a0b19c7
-- Original filename: Karate Cop.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 3c01197d-52a0-4b2e-8f5d-377186b36537
-- Original filename: Killer.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character cfde27ab-7dfd-4f38-98ee-2eccc631be14
-- Original filename: Magic Cop.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character dd07a0f2-0148-4c14-ab0f-f383557214ee
-- Original filename: Martial Artist.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character cb78b93b-fea2-4f30-ad1f-9b69761a5da5
-- Original filename: Gene Freak.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character d02c57aa-9e16-4aa7-9217-c161cea860d0
-- Original filename: Ex-Special Forces.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 46001c17-943e-47ed-bfed-40be516d6c3c
-- Original filename: Masked Avenger.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character fbb2e188-9d06-4987-ba1b-a489280cce5e
-- Original filename: Maverick Cop.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 8cef368d-9101-4b92-89c1-dc5c7965d333
-- Original filename: Ninja.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 8e9477c6-b93a-499e-876c-ebf14427d6a8
-- Original filename: Old Master.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character d9ad1bc8-db91-43ba-8371-fe883ab72aa3
-- Original filename: Private Investigator.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character bcf03792-c296-48d8-baa8-d96261089571
-- Original filename: Redeemed Pirate.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character df233719-e808-4146-aa94-c76efa1d9db4
-- Original filename: Scrappy Kid.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 4c5cae19-e0fc-423c-8133-513e8416d423
-- Original filename: Sifu.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character bf96d7dd-e1df-4532-813c-255d943cea91
-- Original filename: Supernatural Creature.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character e95d3487-5ef2-478c-8035-b878c455e463
-- Original filename: Spy.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character bbc04a45-4523-400b-ac21-89754a0e7440
-- Original filename: Sorcerer.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 670f4efe-30d5-4d40-8a98-3b10e0b937e6
-- Original filename: Sword Master.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 92783b56-c474-412d-95ca-9b23ee3f0b97
-- Original filename: Thief.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 2c2efc13-84ce-45d5-9549-b5b058b2ebe0
-- Original filename: Two-Fisted Archaeologist.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character b1103cf5-a767-4ee3-aa18-4d914ec74f28
-- Original filename: Transformed Dragon.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character bd661084-c670-4910-b568-3a2962a621e5
-- Original filename: Transformed Crab.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction d12ebf38-6bf4-485d-ab01-36e71e99306a
-- Original filename: General Grundle.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction 9afef0d9-233c-4696-b237-aed0515e0500
-- Original filename: The New Simian Army.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction 50a7bc5c-ca36-48b7-a17b-5698c2e1958e
-- Original filename: The Jammers.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction 8a2a13dc-447f-4e71-98fd-732c8d65be78
-- Original filename: Eaters of the Lotus.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction c52de513-622e-4bda-a88e-cec2a5c13ddb
-- Original filename: The Guiding Hand.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction f9c89687-9813-4c50-98fb-ceecfcc5e335
-- Original filename: The Ascended.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction 6bc3abe7-2890-432f-a397-89c763f54d18
-- Original filename: The Dragons.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character aaf89162-4329-4924-9141-dd8ba02c13a8
-- Original filename: Uber-Boss.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 7a367c9d-ad7f-4bc8-9050-30a58a9e4e99
-- Original filename: Boss.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 3947d2d8-163a-4bdd-83e8-0de8f751e861
-- Original filename: Featured Foe.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character 67f709a8-521f-48b5-a3d6-cee40868236a
-- Original filename: Mook.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Character f0310e8e-871f-46c5-8497-f9e484824281
-- Original filename: Ally.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction c2c5b7cc-0c64-4866-97c1-b1c9b0e8c457
-- Original filename: Huan Ken.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction f1b59811-a684-4d3f-a07b-4fcafc79eb7d
-- Original filename: Li Ting.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction ce40d0a1-ed7c-4122-a219-996e46425115
-- Original filename: Pui Ti.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction 954edb9f-afd2-4df8-985d-6756594d0d94
-- Original filename: Ming Yi.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
...
-- Attachment for Faction c44f7eaf-425b-497f-b278-92a3bc612e55
-- Original filename: Manlysaka.png
-- ImageKit URL would be computed from metadata
INSERT INTO active_storage_attachments (
  id, name, record_type, record_id, blob_id,
  created_at
