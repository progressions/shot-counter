...
RSpec.describe "Api::V2::Campaigns", type: :request do
  ...
  describe "GET /index" do
    context "when user is gamemaster" do
      ...
      it "returns campaign attributes" do
        ...
        expect(body["campaigns"][0]).to include("name" => "Adventure", "description" => "Epic adventure", "player_ids" => [@player.id])
        expect(body["campaigns"][0].keys).to contain_exactly("id", "name", "description", "created_at", "updated_at", "active", "player_ids", "entity_class", "image_positions", "characters", "image_url")
      end
  ...
  describe "GET /autocomplete" do
    context "when user is gamemaster" do
      it "gets all active campaigns owned by the gamemaster" do
        get "/api/v2/campaigns", params: { autocomplete: true }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Quest", "Adventure"])
      end
      ...
      it "returns campaign attributes" do
        get "/api/v2/campaigns", params: { autocomplete: true, search: "Adventure" }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].length).to eq(1)
        expect(body["campaigns"][0]).to include("name" => "Adventure")
        expect(body["campaigns"][0].keys).to eq(["id", "name"])
      end

      it "sorts by created_at ascending" do
        get "/api/v2/campaigns", params: { autocomplete: true, sort: "created_at", order: "asc" }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Adventure", "Quest"])
      end
      ...
      it "sorts by created_at descending" do
        get "/api/v2/campaigns", params: { autocomplete: true, sort: "created_at", order: "desc" }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Quest", "Adventure"])
      end
      ...
      it "sorts by name ascending" do
        get "/api/v2/campaigns", params: { autocomplete: true, sort: "name", order: "asc" }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Adventure", "Quest"])
      end
      ...
      it "sorts by name descending" do
        get "/api/v2/campaigns", params: { autocomplete: true, sort: "name", order: "desc" }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Quest", "Adventure"])
      end
      ...
      it "filters by id" do
        get "/api/v2/campaigns", params: { autocomplete: true, id: @campaign.id }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Adventure"])
      end
      ...
      it "filters by search string" do
        get "/api/v2/campaigns", params: { autocomplete: true, search: "Quest" }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Quest"])
      end
      ...
      it "filters by character_id" do
        get "/api/v2/campaigns", params: { autocomplete: true, character_id: @brick.id }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Adventure"])
      end
      ...
      it "filters by vehicle_id" do
        get "/api/v2/campaigns", params: { autocomplete: true, vehicle_id: @tank.id }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Adventure"])
      end
      ...
      it "gets only active campaigns when show_all is false" do
        get "/api/v2/campaigns", params: { autocomplete: true, show_all: "false" }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Quest", "Adventure"])
        expect(body["campaigns"].map { |c| c["name"] }).not_to include("Old Campaign")
      ...
      it "gets all campaigns when show_all is true" do
        get "/api/v2/campaigns", params: { autocomplete: true, show_all: "true" }, headers: @gamemaster_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Old Campaign", "Quest", "Adventure"])
      end
    ...
    context "when user is admin" do
      it "gets all active campaigns owned by the admin" do
        admin_campaign = @admin.campaigns.create!(name: "Admin Campaign", description: "Admin adventure", active: true)
        get "/api/v2/campaigns", params: { autocomplete: true }, headers: @admin_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Admin Campaign"])
      end
    ...
    context "when user is a player" do
      it "gets all active campaigns they are a player in" do
        get "/api/v2/campaigns", params: { autocomplete: true }, headers: @player_headers
        expect(response).to have_http_status(:success)
        body = JSON.parse(response.body)
        expect(body["campaigns"].map { |c| c["name"] }).to eq(["Adventure"])
      end
