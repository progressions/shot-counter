...
RSpec.describe "Api::V1::CharactersAndVehicles", type: :request do
  ...
  describe "GET /characters" do
    ...
    it "returns characters in a fight" do
      ...
      expect(body.first.keys).to eq(["id", "name", "impairments", "action_values", "location", "shot_id"])
    end
    ...
    it "returns vehicles in a fight" do
      ...
      expect(body.first.keys).to eq(["id", "name", "impairments", "action_values", "driver", "location", "shot_id"])
    end
  end
end
